      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.85rem' }}>
          ...
          <div style={{ display: 'flex', gap: '0.75rem', alignItems: 'center' }}>
            {cities.map((c) => (
              <span key={c.name} style={{ display: 'inline-flex', alignItems: 'center', gap: '0.2rem', whiteSpace: 'nowrap' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.85rem' }}>
          ...
          <div style={{ display: 'flex', gap: '0.85rem', alignItems: 'center' }}>
            {marketData.map((m) => (
              <span key={m.name} style={{ display: 'inline-flex', alignItems: 'center', gap: '0.25rem', whiteSpace: 'nowrap' }}>
